                                        ...
                                        <form action="<?= base_url('Blog/approveCommentPost'); ?>" method="post">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    ...
                                                    <?php endif; ?>
                                                    <li><a href="javascript:void(0)" onclick="deleteItem('Blog/deleteComment','<?= $item->id; ?>','<?= trans("confirm_comment", true); ?>');"><i class="fa fa-trash option-icon"></i><?= trans('delete'); ?></a></li>
                                                </ul>
                                            </div>
                                        </form>
                                    </td>
