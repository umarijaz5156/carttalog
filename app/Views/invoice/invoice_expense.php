                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    <p class="font-weight-bold mb-1"><span style="display: inline-block;width: 100px;"><?= trans("invoice"); ?>:</span>#INVE<?= $transaction->id; ?></p>
                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    ...
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= trans("payment_status"); ?>:</span><?= trans("payment_received"); ?></p>
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= trans("payment_method"); ?>:</span><?= trans("wallet_balance"); ?></p>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr style="font-size: 15px;">
                                            <td><?= esc($transaction->expense_detail); ?></td>
                                            <td style="white-space: nowrap"><?= priceFormatted($transaction->expense_amount, $transaction->currency); ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="order-total float-right">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-5 col-right">
                                            <strong class="font-600"><?= priceFormatted($transaction->expense_amount, $transaction->currency); ?></strong>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-7 col-left">
