                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    ...
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= trans("payment_status"); ?>:</span><?= $transaction->payment_status == 'awaiting_payment' ? trans("awaiting_payment") : trans("payment_received"); ?></p>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr style="font-size: 15px;">
                                            ...
                                            <?php if (!empty($currency) && $currency->symbol_direction == 'left'): ?>
                                                <td style="white-space: nowrap"><?= getCurrencySymbol($transaction->currency); ?><?= $transaction->payment_amount; ?></td>
                                            <?php else: ?>
                                                <td style="white-space: nowrap"><?= $transaction->payment_amount; ?><?= getCurrencySymbol($transaction->currency); ?></td>
                                            <?php endif; ?>
                                        </tr>
                                        </tbody>
                                    </table>
