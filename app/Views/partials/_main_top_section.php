...
<?php if (!empty($featuredCategories)):
    ...
    <?php foreach ($featuredCategories as $category): ?>
      ...
      <a href="<?= generateCategoryUrl($category); ?>">
        <img src="<?= getCategoryImageUrl($category); ?>" data-src="<?= getCategoryImageUrl($category); ?>"alt="<?= getCategoryName($category, $activeLang->id); ?>" class="custom-slider-image">
      </a>
      <div class="category-name"><a href="<?= generateCategoryUrl($category); ?>"><?= getCategoryName($category, $activeLang->id); ?></a></div>
      </div>
      <?php endforeach; ?>
    ...
    <?php endif;
                       ...
                       <div class="col-md-12 col-lg-6">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="mb-0 ">Express Delivery</h4>
                        ...
                        <?php foreach ($express as $product): ?>
                                ...
                                <div class="product-card">
                                    <div class="" > 
                                        ...
                                        <i  data-product-id="<?= $product->id; ?>" data-type="list" class="btn-add-remove-wishlist icon-heart-o heart-icon"></i>
                                    </div>
      ...
      <div class="image-container">
        <img src="<?= esc(base_url($banners[8]->image)); ?>" alt="Sample Image">
        <div class="image-text"><?= esc($banners[8]->text); ?></div>
    </div>
                    </div>
