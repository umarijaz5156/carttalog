        ...
        <div class="row">
            <div class="col-12">
                <div class="support">
                    ...
                    <h1 class="title-category"><?= esc($category->name); ?></h1>
                    <div class="row">
                            ...
                            <ul class="ul-support-articles">
                                <?php if (!empty($articles)):
                                    foreach ($articles as $item):; ?>
                                        <li <?= $article->id == $item->id ? 'class="active"' : ''; ?>><a href="<?= generateUrl('help_center') . '/' . esc($category->slug) . '/' . esc($item->slug); ?>"><?= esc($item->title); ?></a></li>
                                    <?php endforeach;
                                endif; ?>
                            </ul>
                        </div>
