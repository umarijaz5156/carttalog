                                    ...
                                    <td>
                                        ...
                                        <?php if ($transaction->payment_method == 'Bank Transfer' && $transaction->payment_status == 'awaiting_payment'):
                                            ...
                                            if ($showReportButton):?>
                                                ...
                                                <?= view('partials/_modal_bank_transfer', ['modalBankTransferId' => 'reportBankTransferModal' . $transaction->id, 'reportType' => 'promote', 'reportItemId' => $transaction->id, 'orderNumber' => '']); ?>
                                            <?php endif;
                                        endif; ?>
                                    </td>
