<div class="blog-item blog-item-small">
    <div class="blog-item-img">
        <a href="<?= generateUrl('blog') . '/' . $item->category_slug . '/' . $item->slug; ?>">
            <img src="<?= base_url(IMG_BG_BLOG_SMALL); ?>" data-src="<?= getBlogImageURL($item, 'image_small'); ?>" alt="<?= esc($item->title); ?>" class="img-fluid lazyload" width="300" height="200" onerror="this.src='<?= base_url(IMG_BG_BLOG_SMALL); ?>'">
        </a>
    </div>
